...
<div class="berita container">
  ...
  <p>Semua destinasi wisata di Jawa Tengah harus melakukan simulasi sebelum diizinkan buka.</p>
  <p>Kewajiban itu juga wajib dilakukan destinasi wisata di daerah berstatus pemberlakuan pembatasan kegiatan masyarakat (PPKM) Level 2.</p> 
  <p>Hasil simulasi selanjutnya dilaporkan terlebih dahulu ke pihak Pemerintah Provinsi (Pemprov) Jawa Tengah.</p>
  <p>Pernyataan tersebut disampaikan oleh Kepala dinas Pemuda, Olahraga, dan Pariwisata (Disporapar) Jawa Tengah Sinoeng N Rachmadi.</p>
  <p>“Daerah diizinkan untuk melakukan simulasi,” kata dia, dilansir dari Tribun Jateng, Kamis (2/9/2021).</p>
  <p>Ia melanjutkan bahwa setelah simulasi, izin pembukaan tempat wisata nantinya menunggu kebijakan Pemprov Jawa Tengah, dalam hal ini Gubernur Jawa Tengah Ganjar Pranowo.</p>
  <p>Sinung pun menyampaikan pesan Ganjar Pranowo bahwa tempat wisata diminta memperbanyak melakukan simulasi.</p>
  <p>“Satu lokasi dulu, kalau sudah tawarkan lagi ke destinasi lainnya. Lha bukanya kapan? Nanti nunggu perkembangan epidemiologi,” ujar dia.</p>
  <p>Pihaknya juga mengutamakan tempat wisata luar ruangan terlebih dahulu untuk mengurangi risiko penularan Covid-19.</p>
  </div>
    </div>
</div>
</div>
...
<div class="beritalain container">
  ...
  <h1>Other News</h1>
  <?php
    $query=mysqli_query($connection,"select * from news where idnews!='id02' ");
    while($row=mysqli_fetch_array($query)) {?>
    <div class="col-md-4">
