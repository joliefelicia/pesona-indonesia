...
<div class="berita container">
  ...
  <p>Vaksinasi di Medan juga terbuka untuk masyarakat umum. Pemkot Medan membuka layanan vaksinasi ini di seluruh puskesmas yang ada di Kota Medan.</p>
  <p>Dia menyebut, tak ada syarat khusus bagi warga umum yang hendak mengikuti vaksinasi.</p> 
  <p>Warga hanya diharuskan membawa identitas diri atau KTP warga Kota Medan. Jika KTP hilang atau tak ada, bisa membawa kartu keluarga untuk mendaftar.</p>
  <p>Selanjutnya, kata dia, pastikan bahwa kondisi kesehatan saat hendak divaksinasi dalam kondisi sehat dan prima.</p>
  <p>Petugas medis di puskemas akan melakukan skrining untuk mengecek kondisi kesehatan sebelum diberi suntikan vaksin.</p>
  <p>"Kalau belum bisa hari itu, bisa datang lagi di kemudian hari. Yang penting sehat agar pembentukan antibodi lebih maksimal," jelasnya.</p>
  <h2>Vaksinasi Dilakukan Secara Bertahap dan Gratis</h2>
  <p>Bagi warga yang hendak mengantre, jika terjadi kerumunan, lebih baik datang di lain hari.</p>
  <p>Selain di puskesmas-puskesmas yang ada, Pemkot Medan juga berkolaborasi dengan sejumlah pihak untuk melakukan vaksinasi massal di sejumlah titik, salah satunya di Lanud Soewondo.</p>
  <p>Dalam waktu dekat, Kementerian BUMN juga akan melakukan vaksinasi massal di daerah ini dengan target 5.000 orang per hari.</p>
  </div>
    </div>
</div>
</div>
...
<div class="beritalain container">
  ...
  <h1>Other News</h1>
  <?php
    $query=mysqli_query($connection,"select * from news where idnews!='id04' ");
    while($row=mysqli_fetch_array($query)) {?>
    <div class="col-md-4">
