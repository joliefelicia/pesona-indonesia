...
and area.provinsiID=provinsi.provinsiID and provinsi.provinsiID='01'");

$hotel=mysqli_query($connection,"select * from hotel where  areaID='id09' ");

$villa=mysqli_query($connection,"select * from villa where  areaID='id09' ");

$guesthouse=mysqli_query($connection,"select * from guesthouse where  areaID='id09' ");
...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      .jumbotron{
        padding-top: 20px;
        background:url(images/pantaiancolsore2.jpg);
        height: 500px;
      }
...
@media (max-width: 991px) {
  ...
  <body>
    <!--menu-->
    <nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background:url(images/pantaiancolsore.jpg);">
<div class="menu container">
<a class="navbar-brand display-3" href="#">
      <img src="images/jakarta.jpg">
     Pesona Indonesia
    </a>
...
<div class="judulpenginapan container">
  <h1 style="text-align:center">Tempat Penginapan di Jakarta</h1>
