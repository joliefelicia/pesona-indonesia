...
and  area.provinsiID=provinsi.provinsiID and provinsi.provinsiID='02' ");

$hotel=mysqli_query($connection,"select * from hotel where  areaID='id07' ");

$villa=mysqli_query($connection,"select * from villa where  areaID='id07' ");

$guesthouse=mysqli_query($connection,"select * from guesthouse where  areaID='id07' ");

$provinsi=mysqli_query($connection,"select * from provinsi where provinsiID='02' ");
...
<html lang="en">
  <head>
    ...
    <style>
      .jumbotron{
        padding-top: 20px;
        background:url(images/danau2.jpg); 
        height: 500px;
      }
...
@media (max-width: 991px) {
  ...
  <body>
    <!--menu-->
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark" style="background:url(images/danau.jpg);">
<div class="menu container">
<a class="navbar-brand display-3" href="#">
      <img src="images/medan.jpg">
     Pesona Indonesia
    </a>
...
<!--akhir menu-->
<div class="jumbotron">
<h1 class="display-4">Sumatera Utara</h1>
</div>
...
<div class="judulpenginapan container">
  <h1>Tempat Penginapan di Sumatera Utara</h1>
