...
$destinasi=mysqli_query($connection,"select * from destinasi,kategori,fotodestinasi, area where kategori.kategoriID=destinasi.kategoriID and destinasi.destinasiID=fotodestinasi.destinasiID and destinasi.areaID=area.areaID and area.areaID='id08'");

$hotel=mysqli_query($connection,"select * from area,hotel where area.areaID=hotel.areaID and  area.areaID='id08' ");

$villa=mysqli_query($connection,"select * from villa where  areaID='id08'");

$guesthouse=mysqli_query($connection,"select * from guesthouse where  areaID='id08' ");
...
<div class="judulpenginapan container">
  <h1 style="text-align:center">Tempat Penginapan di Pontianak</h1>
