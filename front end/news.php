...
<div class="top-news container">
  ...
  <h1>TOP NEWS</h1>
  <?php while($row=mysqli_fetch_array($berita) and $row['idnews']=='id01'){
  ?>
  <div class="media news" style="padding:20px;">
  <img class="align-self-center mr-3" src="images/<?php echo $row['foto'] ?>" alt="A generic square placeholder image with rounded corners in a figure.">
