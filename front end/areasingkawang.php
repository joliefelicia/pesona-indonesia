...
$destinasi=mysqli_query($connection,"select * from destinasi,kategori,fotodestinasi, area where kategori.kategoriID=destinasi.kategoriID and destinasi.destinasiID=fotodestinasi.destinasiID and destinasi.areaID=area.areaID and area.areaID='id05'");

$hotel=mysqli_query($connection,"select * from area,hotel where area.areaID=hotel.areaID and  area.areaID='id05' ");

$villa=mysqli_query($connection,"select * from villa where  areaID='id05'");

$guesthouse=mysqli_query($connection,"select * from guesthouse where  areaID='id05' ");
...
<html lang="en">
  <head>
    ...
    <title>Wisata Kalimantan Barat</title>
    <style type="text/css">
      .media{
      ...
      .jumbotron{
        padding-top: 20px;
        background:url(images/pantaikalimantan2.jpg);
...
@media (max-width: 991px) {
  ...
  <body>
    <!--menu-->
    <nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background:url(images/pantaikalimantan.jpg);">
...
<!--akhir menu-->
<div class="jumbotron">
<h1 class="display-4"> Kalimantan Barat</h1>
</div>
...
<div class="judulpenginapan container" style="margin-bottom: 50px;">
  <h1 style="text-align:center">Tempat Penginapan di Singkawang</h1>
