...
if(isset($_POST['Simpan']))
{
    ...
    if(isset($_REQUEST['inputjudulnews']))
    {
        $namanews=$_REQUEST['inputjudulnews'];
    ...
    {
       ?><h1>Anda harus mengisi data nama di php</h1><?php
       die ('Anda harus mengisi data nama di php');
    }


  $idnews=$_POST['inputidnews'];
  ...
  $ekstensifile=pathinfo($nama,PATHINFO_EXTENSION);
        ...
        if(($ekstensifile == "jpg") or($ekstensifile=="JPG")){
            ...
            mysqli_query($connection,"insert into news values ('$idnews','$namanews', '$deskripsinews','$provinsiid','$nama','$sumber')");
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputidnews" placeholder="IDnews" maxlength="4" >
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputjudulnews" placeholder="judul berita">
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputdeskripsi" placeholder="dekripsi" rows="4" cols="35"></textarea>
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <input type="text" class="form-control"  id="sumber" 
      name="inputsumber" placeholder="sumber berita">
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select class="form-control" name="inputprovinsiid" id="inputprovinsiid">
       <?php 
