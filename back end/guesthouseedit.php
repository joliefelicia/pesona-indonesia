...
<div class="card shadow mb-4">
    ...
    if(isset($_POST['Edit']))
    {
        ...
        mysqli_query($connection, "update guesthouse set namaguesthouse='$namahouse', alamatguesthouse='$alamathouse', areaID='$area',rating='$rating' where guesthouseID='$houseid' ");
    ...
    $kodehouse = $_GET["ubah"];
    $edithouse  = mysqli_query($connection,"select * from guesthouse where guesthouseID ='$kodehouse'");
    $rowedit=mysqli_fetch_array($edithouse);

  $editarea = mysqli_query($connection,"select * from guesthouse, area where guesthouseID = '$kodehouse' and guesthouse.areaID = area.areaID");
...
<div class="col-sm-1">
  ...
  <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Edit Villa</h1>
                </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodehouse" name="inputidhouse" placeholder="Kode guest house" maxlength="4" required="" value="<?php echo $rowedit["guesthouseID"]?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnamahouse" id="namahouse" placeholder="Nama Guest House" value="<?php echo $rowedit["namaguesthouse"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputalamathouse" id="alamathouse" placeholder="Alamat House" value="<?php echo $rowedit["alamatguesthouse"] ?>">
    </div>
  </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputratinghouse" id="ratinghouse" placeholder="Rating Guest House" value="<?php echo $rowedit["rating"]?>">
    </div>
  </div>
    ...
    <div class="row">
        ...
        <table class="table table-hover table-info">
            ...
            if(isset($_POST["Kirim"]))
            {
                ...
                where namahouse like '%".$search."%' and guesthouse.areaID=area.areaID order by guesthouseID ");
