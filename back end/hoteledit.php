...
<div class="card shadow mb-4">
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        mysqli_query($connection, "update hotel set  namahotel='$namahotel',alamathotel='$alamathotel',areaID='$area', bintang='$bintang' where hotelID='$hotelid' ");
...
<div class="col-sm-1">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["hotelID"] ?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnamahotel" id="namahotel" placeholder="Nama hotel" value="<?php echo $rowedit["namahotel"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputalamathotel" id="alamathotel" placeholder="Alamat Hotel" value="<?php echo $rowedit["alamathotel"]?>">
    </div>
  </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputbintanghotel" id="bintanghotel" placeholder="Bintang Hotel" value="<?php echo $rowedit["bintang"] ?>">
    </div>
  </div>
