...
header("location:provinsi.php");
   ...
   //untuk menampilkan data yang mau diedit
    $idprovinsi = $_GET["ubah"];
    $editprovinsi= mysqli_query($connection,"select * from provinsi where provinsiID ='$idprovinsi'");
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputidprovinsi"  maxlength="2" value="<?php echo $rowedit["provinsiID"]?>" readonly>
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputprovinsinama" maxlength="25" value="<?php echo $rowedit["provinsinama"]?>">
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputprovinsitglberdiri"  value="<?php echo $rowedit["provinsitglberdiri"]?>" >
    </div>
   </div>
