...
mysqli_query($connection,"insert into kategori values ('$IDKategori','$namakategori','$ketkategori', '$refkategori')");
...
<div class="row">
  ...
  <div class="col-sm-10">
  	 ...
  	 <div class="jumbotron jumbotron fluid">
        	<div class="container">
        		<h1 class="display-4">form kategori </h1>
        	</div>
...
<form method="POST">
   <div class="form-group row">
    <label for="kodekategori" class="col-sm-2 col-form-label">Kode Kategori: </label>
      ...
      name="inputidkategori" placeholder="kode kategori" maxlength="4"  >
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputnamakategori"placeholder="namakategori"  >
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputketkategori" placeholder="keterangan kategori" >
    </div>
   </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputrefkategori" placeholder="referensi kategori" >
    </div>
   </div>
