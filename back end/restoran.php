...
<?php
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        mysqli_query($connection,"insert into restoran values('$restorankode', '$restorannama' ,'$restoranpemilik','$jenismakanan', '$alamatrestoran','$kodearea','$rating')");
...
<div class="col-sm-1">
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="koderestoran" name="inputidrestoran" placeholder="Kode Restoran" maxlength="4" required="" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnamarestoran" id="namarestoran" placeholder="Nama Restoran">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputpemilik" id="namapemilikrestoran" placeholder="Nama Pemilik Restoran">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputjenismakanan" id="jenismakanan" placeholder="jenis makanan" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputalamatrestoran" id="alamat" placeholder="Alamat Restoran" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputratingrestoran" id="rating" placeholder="Rating Restoran" >
    </div>
  </div>
