...
<div class="row">
	...
	<div class="col-sm-10">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<label for="disabledTextInput" class="col-sm-2 col-form-label" >Kode Photo: </label>
		    <div class="col-sm-10">
            <input type="text" class="form-control" id="kodefoto" name="inputkodefoto" value="<?php echo $rowedit["fotoID"] ?>" maxlength="5" disabled readonly>
            </div>
			</div>
