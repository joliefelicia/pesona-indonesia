...
mysqli_query($connection,"insert into AREA values ('$IDarea','$namaarea','$areawilayah', '$areaketerangan','$provinsiid')");
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputidarea" placeholder="IDarea" maxlength="4" >
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputnamaarea"placeholder="namaarea" maxlength="35">
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputareawilayah" placeholder="areawilayah" maxlength="35">
    </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      name="inputareaketerangan"placeholder="areaketerangan" maxlength="255">
    </div>
   </div>
