...
<?php
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        mysqli_query($connection,"update destinasi set destinasinama='$destinasinama' , destinasialamat='$alamat',kategoriID='$kodekategori',areaID='$kodearea' where destinasiID='$destinasikode'");
        header ("location:destinasi.php");
...
<div class="col-sm-1">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodedestinasi" name="inputkode" placeholder="Kode Destinasi" value="<?php echo $rowedit["destinasiID"] ?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat Destinasi" value="<?php echo $rowedit["destinasialamat"] ?>">
    </div>
  </div>
