...
<div class="card shadow mb-4">
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        mysqli_query($connection, "insert into  admin values('$adminid', '$namaadmin', '$alamatemail', '$password')");
...
<div class="col-sm-1">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodeadmin" name="inputidadmin" placeholder="Kode Admin" maxlength="4" required="" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnamaadmin" id="namaadmin" placeholder="Nama Admin">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="alamatemail" id="alamatemail" placeholder="Alamat Email">
    </div>
  </div>
