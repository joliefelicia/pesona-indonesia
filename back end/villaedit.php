...
<div class="card shadow mb-4">
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        mysqli_query($connection, "update villa set namavilla='$namavilla', alamatvilla='$alamatvilla', areaID='$area',rating='$rating' where  villaID='$villaid'");
    ...
    $kodevilla = $_GET["ubah"];
    $editvilla = mysqli_query($connection,"select * from villa  where villaID ='$kodevilla'");
    $rowedit=mysqli_fetch_array($editvilla);

  $editarea = mysqli_query($connection,"select * from villa, area where villaID = '$kodevilla' and villa.areaID = area.areaID");
...
<div class="col-sm-1">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["villaID"]?>" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnamavilla" id="namavilla" placeholder="Nama Villa" value="<?php echo $rowedit["namavilla"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputalamatvilla" id="alamatvilla" placeholder="Alamat Villa" value="<?php echo $rowedit["alamatvilla"]?>">
    </div>
  </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputratingvilla" id="ratingvilla" placeholder="Rating Villa" value="<?php echo $rowedit["rating"]?>">
    </div>
  </div>
